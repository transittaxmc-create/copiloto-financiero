...
export function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-[#0F172A]/95 backdrop-blur-md border-t border-slate-800/80 flex justify-around items-center py-2 pb-[max(env(safe-area-inset-bottom),0.5rem)] z-40 px-2">
      {items.map((item) => {
