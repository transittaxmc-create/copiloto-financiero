...
export function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-[#0F172A]/95 backdrop-blur-md border-t border-slate-800/80 flex justify-around items-center py-2 z-40 px-2">
      {items.map((item) => {
