...
import { Sparkles, CreditCard, TrendingUp, AlertTriangle, Zap, MessageSquare, ChevronRight } from "lucide-react";
...
export default function AICreditPage(): React.ReactElement {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <DailyEntryHeader />
      <div className="flex gap-2 border-b border-slate-700/50 px-4">
